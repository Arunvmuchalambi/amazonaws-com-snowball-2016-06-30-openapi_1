...
This MCP (Model Content Protocol) server provides access to Amazon Import/Export Snowball API functionality through HTTP, HTTPS, and STDIO transport modes.
